...
function WindowButton({
  ...
  return (
    <button
      ...
      style={{ minWidth: label ? undefined : 44, paddingInline: label ? "10px" : undefined }}
    >
      <span
        style={{ transition: "background-color 120ms, color 120ms" }}
        className={cn(
          "flex h-7 items-center justify-center rounded-md text-muted",
          label ? "px-2 text-[12px] font-medium" : "w-8",
          danger
